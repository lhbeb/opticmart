      ...
      <div className="container mx-auto max-w-4xl">
        <div className="text-center">
          <div className="flex justify-center mb-6">
            <div className="bg-[#0284C7]/30 border border-[#0284C7]/40 backdrop-blur-sm rounded-full p-3.5">
              <Mail className="h-7 w-7 text-[#F8FAFC]" />
            </div>
          </div>

          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Join the OpticMart VIP Club
          </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="flex-1">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-full border-0 bg-[#F8FAFC] text-[#0F172A] placeholder-[#0F172A]/60 focus:outline-none focus:ring-2 focus:ring-[#0284C7] transition-all duration-200"
              ...
              <button
                type="submit"
                disabled={isSubmitting || isSuccess}
                className="bg-[#0284C7] hover:bg-[#306E76] text-white disabled:opacity-50 disabled:cursor-not-allowed px-6 py-3 rounded-full font-bold transition-all duration-200 flex items-center justify-center gap-2 min-w-[140px] shadow-md"
              >
                {isSubmitting ? (
                  <>
            ...
            {isSuccess && (
              <div className="flex justify-center mt-3">
                <p className="text-green-200 font-semibold bg-green-900/40 px-4 py-1.5 rounded-full text-sm backdrop-blur-sm border border-green-400/30">
                  Thanks for subscribing to OpticMart! Check your email for confirmation.
                </p>
              </div>
            )}
          </form>
