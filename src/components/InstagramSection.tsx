...
const InstagramSection: React.FC = () => {
  const instagramUrl = brand.instagram || 'https://www.instagram.com/opticmartofficial/';

  return (
    <section className="py-8 bg-white border-t border-gray-100">
      <div className="w-full px-4">
        <div className="max-w-6xl mx-auto">
          <div className="bg-[#F8FAFC]/60 rounded-xl shadow-sm border border-[#0F172A]/10 p-6 sm:p-8">
            <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0 sm:space-x-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-grow">
                  <h3 className="font-bold text-[#0F172A] text-lg sm:text-xl mb-0.5">@opticmartofficial</h3>
                  <p className="text-gray-600 text-sm sm:text-base mb-2">OpticMart Optics</p>

                  {/* Statistics */}
                  <div className="flex items-center space-x-4 sm:space-x-6 text-sm">
                    <div className="text-center">
                      <div className="font-bold text-[#0F172A]">38</div>
                      <div className="text-gray-500 text-xs">posts</div>
                    </div>
                    <div className="text-center">
                      <div className="font-bold text-[#0F172A]">5,920</div>
                      <div className="text-gray-500 text-xs">followers</div>
                    </div>
                    <div className="text-center">
                      <div className="font-bold text-[#0F172A]">24</div>
              ...
              <div className="flex-shrink-0">
                ...
                >
                  <Instagram className="h-5 w-5 mr-2 text-[#38BDF8]" />
