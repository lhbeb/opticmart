...
export default function PaypalInvoiceConfirmation({
    ...
    const [payeeEmail, setPayeeEmail] = useState('heyopticmart@gmail.com');
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-2 text-sm leading-7 text-emerald-900/85">
                                                    Thank you! Our OpticMart payment team is verifying your PayPal transfer screenshot. <strong>Most orders are confirmed within 2–3 minutes.</strong> You will receive a confirmation email shortly.
                                                </p>
