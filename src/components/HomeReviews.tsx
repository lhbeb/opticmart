          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="border-b border-gray-200 p-6">
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                {/* Rating Summary */}
                <div>
                  <h2 className="text-2xl font-bold text-[#0F172A] mb-1">What OpticMart Customers Say</h2>
                    ...
                    <div>
                      <div className="flex">
                        {[...Array(5)].map((_, i) => (
                          <Star 
                            key={i}
                            className={`h-5 w-5 ${i < Math.floor(reviewStats.averageRating) ? 'text-[#0284C7] fill-[#0284C7]' : 'text-gray-300'}`}
                          />
                        ))}
                      </div>
              ...
              {displayReviews.map((review, index) => {
                ...
                return (
                      ...
                      <div className="flex items-start justify-between gap-2 mb-1">
                        <div className="min-w-0 flex-1">
                          <h3 className="font-medium text-[#0F172A] flex items-center gap-2 flex-wrap">
                            {review.author}
                              {review.verified && (
                              <span className="flex items-center text-[#0284C7] text-xs whitespace-nowrap font-medium">
                  ...
                  {review.productTitle && review.productSlug && (
                    <div className="mb-2">
                      <span className="text-xs text-[#0284C7] hover:text-[#0F172A] hover:underline cursor-default inline-flex items-center gap-1 font-medium">
                        {review.productTitle}
                      </span>
                    </div>
                  )}
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex">
                      {[...Array(5)].map((_, i) => (
                        <Star 
                          key={i}
                          className={`h-3.5 w-3.5 ${i < review.rating ? 'text-[#0284C7] fill-[#0284C7]' : 'text-gray-300'}`}
                        />
                      ))}
                    </div>
                  </div>
              ...
              <form onSubmit={handleSubmitReview} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-[#0284C7] hover:bg-[#0284C7]/10 transition-colors duration-200">
