    ...
    <div className="bg-[#F8FAFC]/40 rounded-xl shadow-sm border border-[#0F172A]/10 p-6">
      <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0 sm:space-x-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* Profile Details */}
          <div>
            <h3 className="font-bold text-[#0F172A] text-lg mb-0.5">OpticMart</h3>
            <p className="text-gray-600 text-sm mb-2">OpticMart Optics</p>
        ...
        <div className="flex-shrink-0">
          ...
          >
            <Instagram className="h-4 w-4 mr-2 text-[#0284C7]" />
            <span>Follow</span>
