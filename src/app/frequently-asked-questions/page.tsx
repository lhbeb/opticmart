    ...
    <main className="min-h-screen bg-[#F8FAFC]/40">
      ...
      <section className="bg-[#0F172A] px-4 py-14 text-[#F8FAFC] sm:py-20">
        <div className="container mx-auto max-w-4xl">
          <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#0284C7]/30 border border-[#0284C7]/40 text-[#F8FAFC]">
            <HelpCircle className="h-6 w-6 text-[#0284C7]" aria-hidden="true" />
          </div>
            ...
            {STORE_FAQS.map((faq) => (
              <details key={faq.question} className="group py-1">
                <summary className="flex cursor-pointer list-none items-center justify-between gap-5 py-5 text-left text-base font-bold text-[#0F172A] marker:content-none sm:py-6 sm:text-lg">
                  ...
                  <Plus
                    className="h-5 w-5 shrink-0 text-[#0284C7] transition-transform duration-200 group-open:rotate-45"
                    aria-hidden="true"
                  />
                </summary>
                <div className="max-w-3xl pb-6 pr-8 text-sm leading-7 text-gray-600 sm:text-base">
                  ...
                  {faq.linkHref && faq.linkLabel && (
                    <Link
                      href={faq.linkHref}
                      className="mt-3 inline-flex items-center gap-1.5 font-semibold text-[#0F172A] hover:text-[#0284C7] underline decoration-[#0284C7] decoration-2 underline-offset-4"
                    >
                      {faq.linkLabel}
