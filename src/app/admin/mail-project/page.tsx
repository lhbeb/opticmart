...
export default function MailProjectPage() {
    if (!process.env.NEXT_PUBLIC_MAIL_PROJECT_URL) return <AdminLayout title="OpticMart Mail"><p>Configure NEXT_PUBLIC_MAIL_PROJECT_URL to connect this brand’s email dashboard.</p></AdminLayout>;
    return (
