...
export const metadata: Metadata = {
  title: 'Shipping Policy | OpticMart',
  description: 'OpticMart shipping coverage, costs, handling times, delivery estimates, and order tracking information.',
};
