    ...
    <main className="min-h-screen bg-[#F8FAFC] py-12">
      ...
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <section className="mt-8 grid gap-5 md:grid-cols-3">
          ...
          <article className="rounded-2xl border border-[#0F172A]/10 bg-white p-6"><Truck className="h-6 w-6 text-[#0284C7]" /><h2 className="mt-4 text-xl font-bold text-[#0F172A]">Transit</h2><p className="mt-2 text-gray-700">Standard transit is estimated at {storePolicy.transitDays.min}–{storePolicy.transitDays.max} business days after dispatch.</p></article>
          <article className="rounded-2xl border border-[#0F172A]/10 bg-white p-6"><PackageCheck className="h-6 w-6 text-[#0284C7]" /><h2 className="mt-4 text-xl font-bold text-[#0F172A]">Shipping cost</h2><p className="mt-2 text-gray-700">Standard shipping is free for eligible U.S. orders. Any different option or charge will be shown before payment.</p></article>
        </section>
