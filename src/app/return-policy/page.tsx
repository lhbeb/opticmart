...
export const metadata: Metadata = {
  title: 'Return & Refund Policy | OpticMart',
  description: 'Eligibility, timing, costs, and instructions for OpticMart returns and refunds.',
};
    ...
    <main className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <section className="mt-8 grid gap-4 sm:grid-cols-3">
          <div className="rounded-2xl border bg-white p-5"><Clock className="h-5 w-5 text-[#0284C7]" /><p className="mt-3 text-sm text-gray-500">Return window</p><p className="font-bold text-[#0F172A]">{storePolicy.returnWindowDays} days</p></div>
          <div className="rounded-2xl border bg-white p-5"><RotateCcw className="h-5 w-5 text-[#0284C7]" /><p className="mt-3 text-sm text-gray-500">Method</p><p className="font-bold text-[#0F172A]">Return by mail</p></div>
          <div className="rounded-2xl border bg-white p-5"><CreditCard className="h-5 w-5 text-[#0284C7]" /><p className="mt-3 text-sm text-gray-500">Refund method</p><p className="font-bold text-[#0F172A]">Original payment method</p></div>
        </section>
