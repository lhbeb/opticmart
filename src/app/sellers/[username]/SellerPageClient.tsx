  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans">
      ...
      <div className="bg-gradient-to-br from-[#0F172A] to-[#0F172A] text-[#F8FAFC] pt-24 pb-12 rounded-b-[40px] shadow-lg relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#0284C7] rounded-full filter blur-[120px] opacity-10 -translate-y-1/2 translate-x-1/2"></div>
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="flex flex-col md:flex-row items-center md:items-end gap-3 mb-2">
                ...
                <div className="relative group flex">
                  <div className="cursor-help flex items-center gap-1.5 bg-[#0284C7] text-white px-2.5 py-1 rounded-full text-xs font-semibold backdrop-blur-sm border border-[#0284C7]/50 transition-colors hover:bg-[#0284C7]/90">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="w-full lg:w-1/3 xl:w-1/4 space-y-6 lg:sticky lg:top-24">
              ...
              <div className="bg-gradient-to-br from-[#0F172A] to-[#0F172A] p-6 rounded-3xl border border-[#0F172A]/10 flex flex-col items-center text-center text-[#F8FAFC] shadow-sm">
                <div className="w-12 h-12 bg-[#0284C7]/15 text-[#0284C7] rounded-full flex items-center justify-center mb-3">
                ...
                <Link href="/contact" className="w-full px-4 py-2.5 bg-[#0284C7] text-white font-medium rounded-xl hover:bg-[#0284C7]/90 transition-colors shadow-sm text-sm">
                  Contact Support
                </Link>
              </div>
            </div>
