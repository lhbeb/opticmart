            ...
            <div className="lg:pr-4">
              ...
              {condition && (
                <div className="mt-3 w-fit max-w-full">
                  ...
                  >
                    <div className="inline-flex max-w-full items-center gap-1.5 rounded-full border border-[#0F172A]/15 bg-white px-3 py-1 text-sm font-medium text-[#0F172A] transition-colors group-hover:border-[#0284C7] group-hover:bg-[#F8FAFC]/50 group-focus-within:border-[#0284C7]">
                      <span className="truncate">{getConditionDisplayLabel(condition)}</span>
                      <Info className="h-4 w-4 flex-shrink-0 text-[#0284C7] transition-colors group-hover:text-[#0F172A] group-focus-within:text-[#0F172A]" />
                    </div>
              ...
              <div className="mt-4 flex flex-wrap items-baseline gap-3">
                ...
                {original_price && original_price > price && (
                  <>
                    ...
                    <span className="inline-flex items-center rounded-full bg-[#0284C7]/20 px-2.5 py-0.5 text-xs font-bold text-[#0F172A] border border-[#0284C7]/40">
              ...
              <ClientOnly>
                {viewedCount !== null && viewedCount > 0 && (
                  <div className="mt-6 bg-[#F8FAFC] border border-[#0284C7]/30 rounded-xl p-3 sm:p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center text-[#0F172A]">
                        <Eye className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-1.5 text-[#0284C7]" />
                        <span className="text-xs sm:text-sm font-medium">{viewedCount.toLocaleString()} viewed in the last 24 hours</span>
                      </div>
                      <div className="flex items-center">
                        <div className="w-2 h-2 bg-[#0284C7] rounded-full animate-pulse mr-2"></div>
                ...
                <div ref={sizeSelectorRef} className="mt-6 border-t border-gray-100 pt-6">
                  <div className="flex items-center justify-between mb-3">
                    <label className="text-sm font-bold text-[#0F172A] uppercase tracking-wide flex items-center gap-1.5 font-heading">
                      <Ruler className="h-4 w-4 text-[#0284C7]" /> Select Size <span className="text-red-500 font-bold">*</span>
                    </label>
                  </div>
                      ...
                      <button
                        ...
                        className={`py-3 px-2 text-sm font-semibold rounded-xl border-2 transition-all duration-200 ${
                          selectedSize === size
                            ...
                            : 'bg-white border-gray-200 text-gray-700 hover:border-[#0284C7] hover:bg-[#F8FAFC]/30'
                        }`}
                      >
                        {size}
                      </button>
                ...
                {product && product.inStock === false ? (
                  ...
                  <>
                    <div className="flex gap-3 lg:flex-col lg:gap-3">
                      ...
                      <button
                        onClick={handleShare}
                        className="lg:hidden flex-shrink-0 w-14 h-14 bg-gray-100 hover:bg-[#F8FAFC] rounded-xl flex items-center justify-center transition-colors duration-200 group border border-transparent hover:border-[#0284C7]/30"
                        style={{ color: '#0F172A' }}
                      ...
                      <button onClick={handleAddToCart} disabled={isAddingToCart || isBuyingNow} className="flex-1 lg:w-full bg-[#0F172A] hover:bg-[#020617] text-[#F8FAFC] py-3.5 lg:py-4 px-6 rounded-xl font-bold shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed text-sm lg:text-base">
                        {isAddingToCart ? <><div className="animate-spin rounded-full h-5 w-5 border-b-2 border-[#F8FAFC] mr-2"></div>Adding to Cart...</> : <><ShoppingCart className="h-5 w-5 mr-2 text-[#0284C7]" />Add to Cart</>}
                      </button>
                    </div>
                    {(product.checkoutFlow === 'paypal-invoice' || product.checkoutFlow === 'paypal-unclaimed' || product.checkoutFlow === 'paypal-direct' || product.checkoutFlow === 'paypal-api') ? (
                      <div className="hidden lg:flex flex-col gap-1.5">
                        ...
                        <p className="flex items-center justify-center gap-1.5 text-[11px] text-gray-500 font-medium tracking-wide">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 text-[#0284C7] flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      >
                        {isBuyingNow ? (
                          ...
                          <>
                            <Zap className="h-5 w-5 mr-2 text-[#0284C7]" />
                            Buy Now
                          </>
                        )}
                      </button>
                ...
                <div className="rounded-[20px] border border-[#EAF2F2] bg-white px-5 py-5">
                  ...
                  {shouldCollapseDescription && (
                    <button
                      ...
                      className="mt-4 text-sm font-semibold text-[#0F172A] hover:text-[#0284C7] transition-colors font-medium"
                    >
            ...
            <section className="rounded-[24px] border border-[#0F172A]/10 bg-white px-8 py-8 shadow-sm">
              ...
              {shouldCollapseDescription && (
                <button
                  type="button"
                  onClick={() => setShowFullDescription((current) => !current)}
                  className="mt-5 text-sm font-semibold text-[#0F172A] hover:text-[#0284C7] transition-colors font-medium"
                >
                  {showFullDescription ? "Show less" : "Show more"}
                </button>
              )}
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="mt-0.5 flex-shrink-0 text-[#0284C7]" aria-hidden="true">
                      ...
                      {isOpen && (
                        <div className="pt-3 text-sm leading-7 text-[#64748B]">
                          ...
                          {item.linkHref && item.linkLabel && (
                            <Link
                              href={item.linkHref}
                              className="mt-2 inline-flex text-sm font-semibold text-[#0F172A] hover:text-[#0284C7] transition-colors"
                            >
                              {item.linkLabel}
                            </Link>
                          )}
              ...
              {faqItems.length > 4 && (
                <div className="border-t border-[#EAF2F2] px-6 py-5 sm:px-8">
                  <button
                    ...
                    className="text-sm font-semibold text-[#0F172A] hover:text-[#0284C7] transition-colors"
                  >
